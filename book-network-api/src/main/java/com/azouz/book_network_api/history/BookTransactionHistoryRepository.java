...
public interface BookTransactionHistoryRepository extends JpaRepository<BookTransactionHistory, Integer> {
   @Query("""
           ...
           WHERE history.user.id = useId
           """)
    Page<BookTransactionHistory> findAllBorrowedBooks(Pageable pageable, @Param("bookId") Integer userId);
    ...
    @Query("""
            ...
            """)
    Page<BookTransactionHistory> findAllReturnedBooks(Pageable pageable, @Param("bookId") Integer userId);
